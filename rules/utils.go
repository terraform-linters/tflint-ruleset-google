...
var validMachineTypes = map[string]bool{
	...
	"h3-standard-88": true,
	// H4D
	"h4d-highmem-192":      true,
	"h4d-highmem-192-lssd": true,
	"h4d-standard-192":     true,
	// M1
	"m1-megamem-96":   true,
	"m1-ultramem-40":  true,
	"m1-ultramem-80":  true,
	...
	"n4d-standard-4":   true,
	"n4d-standard-8":   true,
	"n4d-standard-16":  true,
	"n4d-standard-32":  true,
	"n4d-standard-48":  true,
	"n4d-standard-64":  true,
	"n4d-standard-80":  true,
	"n4d-standard-96":  true,
	"n4d-highcpu-2":    true,
	"n4d-highcpu-4":    true,
	"n4d-highcpu-8":    true,
	"n4d-highcpu-16":   true,
	...
	"ct5p-hightpu-4t":   true,
	"ct6e-standard-1t":  true,
	"ct6e-standard-4t":  true,
	"ct6e-standard-8t":  true,
	"tpu7x-standard-4t": true,
...
func isCustomType(machineType string) bool {
	return strings.HasPrefix(machineType, "e2-custom-") ||
		...
		strings.HasPrefix(machineType, "n4d-custom-") ||
