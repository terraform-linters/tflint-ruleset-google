...
func NewGoogleAppEngineFlexibleAppVersionInvalidServingStatusRule() *GoogleAppEngineFlexibleAppVersionInvalidServingStatusRule {
	return &GoogleAppEngineFlexibleAppVersionInvalidServingStatusRule{
		resourceType:  "google_app_engine_flexible_app_version",
		attributeName: "serving_status",
	}
}

// Name returns the rule name
func (r *GoogleAppEngineFlexibleAppVersionInvalidServingStatusRule) Name() string {
	return "google_app_engine_flexible_app_version_invalid_serving_status"
}
