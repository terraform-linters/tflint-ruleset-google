...
func (r *GoogleContainerNodePoolInvalidMachineTypeRule) Severity() tflint.Severity {
	return tflint.ERROR
}
...
func (r *GoogleContainerNodePoolInvalidMachineTypeRule) Check(runner tflint.Runner) error {
	resources, err := runner.GetResourceContent("google_container_node_pool", &hclext.BodySchema{
